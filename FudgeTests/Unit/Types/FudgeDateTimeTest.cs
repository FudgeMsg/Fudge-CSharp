...
namespace Fudge.Tests.Unit.Types
{
    public class FudgeDateTimeTest
    {
        ...
        public void VariousConstructors()
        {
            ...
            Assert.Equal("1978-04-03T01:17:34.000000000", new FudgeDateTime(dt).ToString());
            Assert.Equal("1978-04-03T01:17", new FudgeDateTime(dt, FudgeDateTimePrecision.Minute).ToString());
            Assert.Equal("1978-04", new FudgeDateTime(dt, FudgeDateTimePrecision.Month).ToString());

            Assert.Equal("1978-04-03T01:17:34.123456789", new FudgeDateTime(1978, 4, 3, 1, 17, 34, 123456789, FudgeDateTimePrecision.Nanosecond).ToString());
            Assert.Equal("1978-04-03", new FudgeDateTime(1978, 4, 3, 1, 17, 34, 123456789, FudgeDateTimePrecision.Day).ToString());
            Assert.Equal("1978-04-03T01:17:34.123456789-01:30", new FudgeDateTime(1978, 4, 3, 1, 17, 34, 123456789, -90, FudgeDateTimePrecision.Nanosecond).ToString());
            ...
            Assert.Equal("1978-04-03T01:17:34", new FudgeDateTime(new FudgeDate(19780403), new FudgeTime(1, 17, 34)).ToString());
            ...
            Assert.Equal("1234-05-06T07:08:09.000000000+02:30", new FudgeDateTime(dto).ToString());
            Assert.Equal("1234-05-06T07:08+02:30", new FudgeDateTime(dto, FudgeDateTimePrecision.Minute).ToString());
